...
public class FLIPZON implements Application{
    ...
    public static void AddCategory(int cat_id,Category c){
        ...
        s.append("Insert into productcategory(categoryid,categoryname) values(");
        s.append(c.getCategory_id());
        s.append(",");
        s.append(c.getCategory_name());
        s.append(");");
        // sql statement to add category to db
    }
    ...
    public static void print_product_catalog(){
        if(product_catalog.size()==0){
            ...
            String s="Select productid, productname, productbrand, productprice from product LIMIT 15;";
